...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A handcrafted keepsake page for Jaygram, written by his sister. Letters, memories, photographs and a song, all in one place." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "A HerPage for Jaygram | More than a gift, a memory" },
      { property: "og:description", content: "A handcrafted keepsake page for Jaygram, written by his sister. Letters, memories, photographs and a song, all in one place." },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;0,500;1,300&family=Jost:wght@300;400;500&family=Caveat:wght@400;500&display=swap",
      },
      {
        rel: "stylesheet",
        href: appCss,
